<template>
  <div>
    <h1 class="text-center primary--text">EDIT &amp; CREATE ADMINS</h1>
    <p>
      <v-btn color="primary" @click="dialog = !dialog">Add Admin</v-btn>
    </p>
    <v-divider></v-divider>
    <div class="pt-4">
    ...
    <div>
      <v-dialog v-model="dialog" width="600">
        <v-form ref="form" @submit.prevent="addAdmin()">
          <v-card>
            <v-card-title>
              <p class="primary--text font-weight-bold">Add Admin</p>
              <v-spacer></v-spacer>
    ...
    <div>
      <v-dialog v-model="dialogEdit" width="600">
        <v-form ref="form" @submit.prevent="updateAdmin()">
          <v-card>
            <v-card-title>
              <p class="primary--text font-weight-bold">Update Admin</p>
              <v-spacer></v-spacer>
...
export default {
  ...
  mounted() {
    ...
    this.$axios('/api/admin/adminList').then((res) => {
  ...
  methods: {
    addAdmin() {
      if (this.$refs.form.validate()) {
        ...
        this.$axios
          .post('/api/admin/store/admin', formData)
          .then((res) => {
